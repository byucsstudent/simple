...
### Creating a SPA n-tier web app

Create a SPA n-tier web app using React and Supabase.
...
```json
{
  ...
  "discipline": "Software engineering",
  "problemType": "Website creation",
  "difficulty": 3,
  "mode": "practice",
  "instability": false,
  "scenarioTitle": "Creating a SPA n-tier web app",
